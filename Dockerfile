...
RUN curl --output clever-tools_linux.tar.gz https://clever-tools.cellar.services.clever-cloud.com/releases/1.2.1-beta.0/clever-tools-1.2.1-beta.0_linux.tar.gz \
