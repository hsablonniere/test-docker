...
RUN curl --output clever-tools_linux.tar.gz https://m84ilsmeqobuxempbkuc.cellar-c2.services.clever-cloud.com/releases/3.15.0/clever-tools-3.15.0_linux.tar.gz \
