...
RUN curl --output clever-tools_linux.tar.gz https://clever-tools.cellar.services.clever-cloud.com/releases/1.5.0-beta.2/clever-tools-1.5.0-beta.2_linux.tar.gz \
