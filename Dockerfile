...
RUN curl --output clever-tools_linux.tar.gz https://m84ilsmeqobuxempbkuc.cellar-c2.services.clever-cloud.com/releases/1.33.0/clever-tools-1.33.0_linux.tar.gz \
